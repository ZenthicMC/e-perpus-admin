<?php
    ...
    list($result,$jumlahData,$dataAwal,$dataPerHalaman,$halamanAktif,$jumlahHalaman) = pagination(10,'books');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">List Books</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"></div>
                                    <a href="new.php?type=Books" class="btn btn-primary btn-icon-split btn-sm">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?type=Books&id=<?= $data['id_buku']; ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fas fa-pen text-white"></i>
                                                </a>
                                                <a href="javascript:confirmBtn();" class="btn btn-danger btn-circle btn-sm mt-1">
                                        ...
                                        <script>
                                            function confirmBtn() {
                                                ...
                                                if (result.isConfirmed) {
                                                    location.href = "../admin/delete.php?type=Books&id=<?= $data['id_buku']; ?>";
                                                }
                                                })
                                            }
                                        </script>
