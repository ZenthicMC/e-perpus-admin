                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-primary py-2 border-left-primary">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>TOTAL BOOKS</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= $jmlhBook; ?></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2 border-left-success">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>ACTIVE VISITORS</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>xx</span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2 border-left-danger">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span style="color: var(--bs-danger);">TOTAL ADMIN</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= $jmlhAdmin; ?></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2 border-left-warning">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>TOTAL USERS</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= $jmlhUser; ?></span></div>
                                        </div>
