...
<div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Add New <?= $type;?></h1>
                        <p class="mb-4">Lengkapi Form Ini Untuk Menambahkan <?= $type;?> Baru!</p>
                    </div>
                    ...
                    <div class="card shadow mb-4 w-50 border-left-primary">
                        ...
                        <div class="card-body ">
                            <?php if ($type == 'Books') : ?>
                            <form class="user" action="new.php?type=<?= $type;?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-4">
                                    <input class="btn btn-primary btn-icon-split" type="submit" name="submit" value="Tambah <?= $type;?>" style="width:30%;height: 40px;">
                                </div>
                            </form>
                            <?php endif; ?>
                            <?php if ($type == 'Users') : ?>
                            <form class="user" action="new.php?type=<?= $type;?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select name="roles" id="roles" style="width:100%;height:50px;border: 1px solid lightgrey;border-radius: 5px;font-size:14px;padding: 10px 10px;" required>
    ...
    <?php if(isset($_POST['submit'])) : ?>
        ...
        <?php elseif($type=='Books') : ?>
            ...
            <?php elseif(tambah($_POST,$type) == 2) : ?>
                <script>
                    Swal.fire({
                    icon: 'error',
                    title: 'Error...',
                    text: 'Ukuran filemu terlalu besar!',
                    })
                </script>

            <?php elseif(tambah($_POST,$type) == 3) : ?>
                <script>
                    Swal.fire({
                    icon: 'error',
                    title: 'Error...',
                    text: 'Ekstensimu tidak valid!',
                    })
                </script>

            <?php elseif(tambah($_POST,$type) == 4) : ?>
                <script>
                    Swal.fire({
                    icon: 'error',
                    title: 'Error...',
